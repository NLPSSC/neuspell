...
def _download_pretrained_model(ckpt_path: str):
    ...
    if os.path.exists(vocab_path):
        print(
            f"`vocab.pkl` already exists in {ckpt_path}. Continuing with other downloads ..."
        )
    else:
        vocab_url = details["vocab.pkl"]
    ...
    if os.path.exists(pytorch_model_path):
        print(
            f"`pytorch_model.bin` already exists in {ckpt_path}. Continuing with other downloads ..."
        )
    else:
        print(
