...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 4:
        ...
        if FINETUNE == "probword":
            SRC_CHECKPOINT_PATH = os.path.join(
                BASE_PATH, "checkpoints/cnn-lstm-probwordnoise"
            )
    ...
    if TRAIN_NOISE_TYPE == "word":
        ...
        CHECKPOINT_PATH = os.path.join(
            BASE_PATH, "checkpoints/cnn-lstm-probwordnoise_v2"
        )
    elif TRAIN_NOISE_TYPE == "bea40kfinetune":
        CHECKPOINT_PATH = os.path.join(
            BASE_PATH, "checkpoints/cnn-lstm-probwordnoise-bea40kfinetune"
        )
    elif TRAIN_NOISE_TYPE == "moviereviewsfinetune":
        CHECKPOINT_PATH = os.path.join(
            BASE_PATH, "checkpoints/cnn-lstm-probwordnoise-moviereviewsfinetune2"
        )
    ...
    if START_EPOCH > 0:
        ...
        files1 = [
            "test.bea60k.ambiguous_natural_v7",
            "test.bea60k.ambiguous_natural_v8",
        ]
        files2 = [
            "test.bea60k.ambiguous_natural_v7.noise",
            "test.bea60k.ambiguous_natural_v8.noise",
        ]
        INFER_BATCH_SIZE = 8
        # '''
        """
