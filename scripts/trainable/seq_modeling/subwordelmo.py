...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 4:
        ...
        if FINETUNE == "probword":
            SRC_CHECKPOINT_PATH = os.path.join(
                BASE_PATH, "checkpoints/subwordelmo-probwordnoise"
            )
    ...
    if TRAIN_NOISE_TYPE == "word":
        ...
        CHECKPOINT_PATH = os.path.join(
            BASE_PATH, "checkpoints/subwordelmo-probwordnoise-bea40kfinetune"
        )
    elif TRAIN_NOISE_TYPE == "moviereviewsfinetune":
        CHECKPOINT_PATH = os.path.join(
            BASE_PATH, "checkpoints/subwordelmo-probwordnoise-moviereviewsfinetune2"
        )
